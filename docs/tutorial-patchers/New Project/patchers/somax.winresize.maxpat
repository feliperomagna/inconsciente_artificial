...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 313.035782044311873, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 188.0, 44.0, 139.0, 22.0 ],
					"text" : "patcherargs width height"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 130.852039000002833, 221.035782044311873, 46.0, 22.0 ],
					"text" : "+ #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 71.352039000002833, 221.035782044311873, 46.0, 22.0 ],
					"text" : "+ #1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "route window bang"
				}

			}
, 			{
				"box" : 				{
					"comment" : "bang to trigger, thispatcher input",
					"id" : "obj-86",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
