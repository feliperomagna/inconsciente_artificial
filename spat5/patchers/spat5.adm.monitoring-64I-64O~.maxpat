...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 230.0, 29.0, 21.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 629.5, 114.0, 40.0, 20.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 629.5, 142.0, 19.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 907.477294999999913, 260.0, 34.0, 21.0 ],
					"text" : "/stop"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 130.0, 107.75, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 811.477295000000026, 400.0, 280.0, 188.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.477325, 550.0, 174.522674999999992, 75.0 ],
					"presentation_linecount" : 4,
					"text" : "bpatcher spat5.adm.renderer-64I-64O~.maxpat with an offset for displaying only the post-rendering vu-meters"
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "spat5.adm.renderer-64I-64O~.maxpat",
					"numinlets" : 3,
					"numoutlets" : 1,
					"offset" : [ 0.0, -150.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.230765999999999, 257.75, 479.753966999999989, 303.5 ],
					"presentation" : 1,
					"presentation_rect" : [ -9.753966999999999, 60.0, 479.753966999999989, 150.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.477325, 20.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.984740999999985, 563.25, 66.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.5, 360.0, 29.0, 21.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 820.0, 280.5, 129.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.5, 260.0, 34.0, 21.0 ],
					"text" : "/start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 858.0, 220.0, 35.0, 21.0 ],
					"text" : "/start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 840.5, 189.0, 54.0, 21.0 ],
					"text" : "route 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 840.5, 70.0, 100.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 840.5, 40.0, 76.0, 21.0 ],
					"text" : "spat5.osc.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.5, 10.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 800.0, 189.0, 29.5, 21.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 180.0, 29.0, 21.0 ],
					"text" : "thru"
				}
...
,
					"patching_rect" : [ 537.874145999999996, 409.0, 56.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.874145999999996, 360.0, 29.0, 21.0 ],
					"text" : "thru"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-21::obj-126::obj-27::obj-21" : [ "live.menu", "live.menu", 0 ],
			...
			"obj-32::obj-22" : [ "live.text[6]", "live.text[9]", 0 ],
