...
, 			{
		...
		"parameters" : 		{
			...
			"obj-42" : [ "live.dial[1]", "ramp", 0 ],
			"obj-50" : [ "live.dial[2]", "ramp", 0 ],
			"obj-52" : [ "live.tab[1]", "live.tab[1]", 0 ],
			"obj-55" : [ "live.toggle[4]", "live.toggle[2]", 0 ],
			"obj-58" : [ "live.toggle[7]", "live.toggle[2]", 0 ],
			"obj-66" : [ "live.dial[11]", "dry/wet", 0 ],
			"obj-70" : [ "live.toggle[8]", "live.toggle[8]", 0 ],
