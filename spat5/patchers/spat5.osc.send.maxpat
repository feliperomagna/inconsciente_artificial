...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 400.0, 76.0, 21.0 ],
					"text" : "prepend /ping"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 493.0, 81.0, 21.0 ],
					"text" : "/ping 127.0.0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 430.0, 67.0, 21.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 928.0, 431.0, 45.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 11.0, 30.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.0, 603.0, 61.0, 19.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 850.0, 550.0, 145.0, 21.0 ],
					"text" : "spat5.osc.route /packet/loss"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 70.0, 33.0, 21.0 ],
									"text" : "== 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 159.0, 46.0, 21.0 ],
									"text" : "sel 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 50.0, 110.0, 239.0, 21.0 ],
									"text" : "t i b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 270.0, 150.0, 53.0, 21.0 ],
									"text" : "del 1500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 190.0, 80.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 190.0, 80.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 190.0, 80.0, 33.0 ],
...
,
					"patching_rect" : [ 850.0, 573.0, 80.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 849.0, 597.0, 68.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 13.0, 14.0, 14.0 ],
					"proportion" : 0.39,
					"rounded" : 40,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 850.0, 523.0, 61.0, 21.0 ],
					"text" : "spat5.ping"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 294.0, 45.0, 21.0 ],
					"text" : "rate $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 486.0, 80.0, 21.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-21" : [ "OSCIP4", "IP4", 0 ],
			"obj-41" : [ "live.text[63]", "live.text[8]", 0 ],
