...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"embed" : 0,
									"id" : "obj-4",
									"maxclass" : "spat5.hoa.beam.embedded",
									"numinlets" : 1,
									"numoutlets" : 2,
									"order" : 4,
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.5, 220.0, 354.0, 321.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.5, 570.0, 241.5, 50.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 452.0, 280.0, 186.0, 38.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
,
									"text" : "check spat5.hoa.beam help patcher",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 460.0, 320.0, 170.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 550.0, 220.0, 183.0, 23.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 460.0, 220.0, 88.0, 21.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 180.0, 90.0, 38.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 128.5, 170.0, 147.0, 50.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
											"expression" : "themecolor.theme_bubble_bgcolor"
										}
...
,
									"text" : "spat5.hoa.beam.embedded @order 4 @dimension 2",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "spat5.hoa.beam.embedded" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"name" : "spat5.hoa.beam.embedded.mxo",
				"type" : "iLaX"
			}
, 			{
